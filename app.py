...
def analyze_image(image):
    ...
    health_classes = ['Healthy', 'Pink Bollworm Damage', 'Discoloration', 'Other Damage']
    ...
    elif health_idx == 2:  # Discoloration
...
if __name__ == '__main__':
    print("=" * 60)
    print("Agri-Vision Cotton Analysis System")
    print("=" * 60)
    print("\nStarting Flask application...")
    print("Open http://localhost:5000 in your browser")
    print("\nEndpoints:")
    print("  /              - Home page")
    print("  /analyze       - Upload and analyze image")
    print("  /demo          - View demo results")
    print("  /api/analyze   - API endpoint (POST)")
